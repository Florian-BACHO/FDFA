...
def main(args_list=None):
    ...
    parser.add_argument('--train-mode', choices=['BP', 'DKP', 'DFA', 'DirDFA'], default='DirDFA',
                        help='choose between backpropagation (BP), Direct Kolen Pollack (DKP), '
                             'Direct Feedback Alignment (DFA) or Directional DFA (DirDFA)')
    ...
    if args.train_mode in ['DKP', 'DirDFA']:
    ...
    require_dir_der = args.train_mode == 'DirDFA'
